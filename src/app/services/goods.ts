...
export class Goods {
  ...
  goods: GoodsType[] = [
    {
      ...
      description:
        'Програма протиаллергічного очищення парою видаляє 99.99 відсотків бактерій і вірусів Одяг виглядає як новий удвічі довше Завдяки цьому одяг зберігає свій вигляд довше, а вода і електроенергія витрачаються економніше.',
    ...
    },
    {
      ...
      description:
        'Графічний планшет Wacom Intuos, обладнаний легким надточним цифровим пером і завантажуваним програмним забезпеченням*, яке відповідає вашому стилю роботи. Виріб створений для того, щоб втілити ваші найсміливіші ідеї в життя.',
    ...
    },
    {
      ...
      description:
        "Завдяки зручному однокамерному дизайну, він займає мінімум місця, але при цьому має достатній об'єм для зберігання продуктів — 83 л у холодильній камері та 10 л у морозильній. ",
    ...
    },
    {
      ...
      description:
        'Чоловічі крокси Crocs Echo Clog в сучасному спортивному дизайні з масивною підошвою. Легкі та зручні, вони забезпечують комфорт при щоденному носінні.',
    ...
    },
    {
      ...
      description:
        'Дощовик-пончо з капюшоном у чохлі – ідеальний аксесуар для подорожей. Легкий та компактний, він легко поміщається у рюкзак або сумку, забезпечуючи надійний захист від дощу під час подорожі.',
    ...
    },
    {
      ...
      description:
        'Розчинна MacCoffee Original 3 в 1 - це суміш добірних кавових зерен, немолочних вершків і цукру.',
    ...
    },
    {
      ...
      description:
        'Глазур кондитерська (вміст: цукор-пісок білий, жир кондитерський, какао-порошок, лецитин, ароматизатор шоколад, ванілін), чорнослив вялений, ядро волоського горіха обсмажене, цукор-пісок білий, вода.',
    ...
    },
    {
      ...
      description:
        'Versele-Laga Prestige Вudgies ВЕРСЕЛЕ-ЛАГА ПРЕСТИЖ ПАПУЖКА — це традиційне повноцінне харчування для хвилястих та інших маленьких папужок.',
    ...
    },
    {
      ...
      description:
        'Зручна пластикова переноска MP Bergamo Gipsy XS smal для транспортування котів і невеликих собак. Дає змогу легко та з мінімальним стресом перевозити улюбленця, водночас убезпечивши його від можливих травм чи втечі.',
    ...
    },
    {
      ...
      description:
        'Гелеві капсули для прання Persil - трикамерні капсули з дозованою кількістю концентрованого засобу. Капсули Universal використовують для прання білих та світлих речей. ',
    ...
    },
    {
      ...
      description:
        'Виготовлені з сировини з переважанням хвойної целюлози, що надає паперовим рушникам усі необхідні якості: добре вбирають рідину, міцні, не прилипає до харчових продуктів.',
  ...
  cartGoods = signal<CartGoodsType[]>(
